        ...
        <table class="table table-light table-striped">
            ...
            <?php 
                ...
                while($fila=mysqli_fetch_row($resultados)){
                    ...
                    <td>$fila[2]</td>
                    <td>$fila[3]</td>
                    <td><a data-value='$fila[0]' class='btn btn-danger btnsBorrar'><i class='fa fa-trash text-white'></i></a>
                    <a class='btn btn-warning'><a href='editarmascota.php?id=$fila[0]&nombre=$fila[1]&edad=$fila[2]&img=$fila[5]&descripcion=$fila[6]'><i class='fa fa-edit text-white'></i></a></td>
                    </tr>";
                }
