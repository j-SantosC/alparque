...
<div class="container">
    ...
    ?>
        ...
        <div class="row ">
            <div class="col text-center">
               <h5 class=" mt-5 text-secondary font-italic">Como estan tus mascotas?</h5> 
    ...
    <div class="row fondo my-5 ">
        <div class="col-md-8 mx-auto text-center mt-3">  
            <form action="horario.php" method="post">
                ...
                <a href="buscar.php"> <h5 class=" p-3 my-auto btn btn-outline-light"><i class=" fas  mr-3  fa-search "></i>Ir al Buscador</h5></a>
